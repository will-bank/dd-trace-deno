...
const startChannel = dc.channel('apm:fs:operation:start')
const finishChannel = dc.channel('apm:fs:operation:finish')
const errorChannel = dc.channel('apm:fs:operation:error')
...
names.forEach(name => {
  addHook({ name }, (fs: { promises: { realpath: any } | { [x: string]: any; } | string | { [x: string]: any; }; realpath: any; realpathSync: any; Dir: { prototype: any } }) => {
...
function isFirstMethodReturningFileHandle (original: { name: string }) {
...
function getFileHandlePrototype (fh) {
  ...
  if (!kHandle) {
    ...
    kHandle = Reflect.ownKeys(fh).find((key: { toString: () => { (): any; new(): any; includes: { (arg0: string): any; new(): any } } }) => typeof key === 'symbol' && key.toString().includes('kHandle'))
  }
  return Object.getPrototypeOf(fh)
}

function getSymbolName (sym: symbol) {
...
function createWrapDirAsyncIterator () {
  return function wrapDirAsyncIterator (asyncIterator: { apply: (arg0: any,arg1: IArguments) => any }) {
...
function wrapCreateStream (original: { name: string | number; apply: (arg0: any,arg1: IArguments) => any }) {
  const classes = {
...
function getMethodParamsRelationByPrefix (prefix: string) {
...
function createWatchWrapFunction (override = '') {
  return function wrapFunction (original: { name: any; apply: (arg0: any,arg1: IArguments) => any }) {
...
function getMessage (operation: string, params: string | any[], args: IArguments | any[], self: { path: any; fd: any }) {
  const metadata = {}
  if (params) {
...
function massWrap (target: string | { [x: string]: any }, methods: string[], wrapper: { (target: any,name: any,wrapper: any): any; (method: any,logCh: any): () => any; (method: any): (path: any) => any; (method: any): (request: any) => any; (method: any,path: any,type: any): any; (target: any,name: any,wrapper: any): any; (method: any,logCh: any): () => any; (method: any): (path: any) => any; (method: any): (request: any) => any; (method: any,path: any,type: any): any; (target: any,name: any,wrapper: any): any; (method: any,logCh: any): () => any; (method: any): (path: any) => any; (method: any): (request: any) => any; (method: any,path: any,type: any): any; (original: any): () => any; (original: any): () => any; (original: any): () => any }) {
  for (const method of methods) {
    wrap(target, method, wrapper)
  }
}

function wrap (target: string | { promises: { realpath: any; }; realpath: any; realpathSync: any; Dir: { prototype: any; }; } | { promises: { realpath: any; } | { [x: string]: any; }; realpath: any; realpathSync: any; Dir: { prototype: any; }; } | { [x: string]: any; }, method: string, wrapper: number | ({ (target: any, name: any, wrapper: any): any; (method: any, logCh: any): () => any; (method: any): (path: any) => any; (method: any): (request: any) => any; (method: any, path: any, type: any): any; (target: any, name: any, wrapper: any): any; (method: any, logCh: any): () => any; (method: any): (path: any) => any;...) | ((original: { name: any; apply: (arg0: any, arg1: IArguments) => any; }) => () => any) | ((original: { name: string | number; apply: (arg0: any, arg1: IArguments) => any; }) => (path: any, options: any) => any) | ((asyncIterator: { apply: (arg0: any, arg1: IArguments) => any; }) => () => any)) {
  try {
