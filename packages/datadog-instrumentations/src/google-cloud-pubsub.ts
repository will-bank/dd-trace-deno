...
const requestStartCh = dc.channel('apm:google-cloud-pubsub:request:start');
const requestFinishCh = dc.channel('apm:google-cloud-pubsub:request:finish');
const requestErrorCh = dc.channel('apm:google-cloud-pubsub:request:error');

const receiveStartCh = dc.channel(`apm:google-cloud-pubsub:receive:start`);
const receiveFinishCh = dc.channel('apm:google-cloud-pubsub:receive:finish');
const receiveErrorCh = dc.channel('apm:google-cloud-pubsub:receive:error');
...
function wrapMethod(method: { name: any; apply: (arg0: any, arg1: IArguments) => Promise<any> }) {
...
function massWrap(
  ...
  methods: string[],
  wrapper: {
    (target: any, name: any, wrapper: any): any;
    (method: any, logCh: any): () => any;
    (method: any): (path: any) => any;
    (method: any): (request: any) => any;
    (method: any, path: any, type: any): any;
    (target: any, name: any, wrapper: any): any;
    (method: any, logCh: any): () => any;
    (method: any): (path: any) => any;
    (method: any): (request: any) => any;
...
addHook({ name: '@google-cloud/pubsub', versions: ['>=1.2'] }, (obj: { Subscription: any }) => {
  ...
  shimmer.wrap(
    ...
    'emit',
    (emit: { apply: (arg0: any, arg1: IArguments) => any }) =>
      function (eventName: string, message) {
...
addHook(
  { name: '@google-cloud/pubsub', versions: ['>=1.2'], file: 'build/src/lease-manager.js' },
  (obj: { LeaseManager: any }) => {
    ...
    shimmer.wrap(
      ...
      '_dispense',
      (dispense: { apply: (arg0: any, arg1: IArguments) => any }) =>
        function (message) {
    ...
    shimmer.wrap(
      LeaseManager.prototype,
      'remove',
      (remove: { apply: (arg0: any, arg1: IArguments) => any }) =>
        function (message) {
    ...
    shimmer.wrap(
      LeaseManager.prototype,
      'clear',
      (clear: { apply: (arg0: any, arg1: IArguments) => any }) =>
        function () {
...
addHook(
  { name: '@google-cloud/pubsub', versions: ['>=1.2'] },
  (obj: { v1: { PublisherClient: any; SchemaServiceClient: any; SubscriberClient: any } }) => {
