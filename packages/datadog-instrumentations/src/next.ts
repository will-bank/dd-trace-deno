...
const finishChannel = dc.channel('apm:next:request:finish');
const errorChannel = dc.channel('apm:next:request:error');
const pageLoadChannel = dc.channel('apm:next:page:load');

const requests = new WeakSet();
const requestToNextjsPagePath = new WeakMap();

function wrapHandleRequest(handleRequest: { apply: (arg0: any, arg1: IArguments) => any }) {

  return function (
    req: string | { apply: (arg0: any, arg1: any) => any } | { originalRequest: any },
    res,
    pathname,
    query,
  ) {
...
function wrapHandleApiRequest(handleApiRequest: { apply: (arg0: any, arg1: IArguments) => any }) {
...
function wrapHandleApiRequestWithMatch(handleApiRequest: { apply: (arg0: any, arg1: IArguments) => any }) {

  return function (
    req: string | { apply: (arg0: any, arg1: any) => any } | { originalRequest: any },
    res,
    query,
    match: { definition: { pathname: any } },
  ) {
...
function wrapRenderToResponse(renderToResponse: { apply: (arg0: any, arg1: IArguments) => any }) {
  return function (ctx: { req: any; res: any }) {

    return instrument(ctx.req, ctx.res, () => renderToResponse.apply(this, arguments));
  };
}

function wrapRenderErrorToResponse(renderErrorToResponse: { apply: (arg0: any, arg1: IArguments) => any }) {
  return function (ctx: { req: any; res: any }) {
...
function wrapRenderToHTML(renderToHTML: { apply: (arg0: any, arg1: IArguments) => any }) {
...
function wrapRenderErrorToHTML(renderErrorToHTML: { apply: (arg0: any, arg1: IArguments) => any }) {
...
function wrapFindPageComponents(findPageComponents: { apply: (arg0: any, arg1: IArguments) => any }) {

  return function (pathname: { pathname: any }, query) {
...
function getPagePath(page: { pathname: any }) {
  return typeof page === 'object' ? page.pathname : page;
}

function getPageFromPath(page: { pathname: any }, dynamicRoutes = []) {
...
function instrument(req: { originalRequest: any }, res: { originalResponse: any }, handler: IArguments) {
  ...
  return startChannel.runStores(ctx, () => {
    try {
      ...
      return promise.then(
        ...
        (err: undefined) => finish(ctx, null, err),
      );
    } catch (e) {
...
function wrapSetupServerWorker(setupServerWorker: { apply: (arg0: any, arg1: IArguments) => any }) {
  return function (requestHandler: { apply: (arg0: any, arg1: IArguments) => any }) {
    arguments[0] = shimmer.wrap(requestHandler, wrapRequestHandler(requestHandler));
    return setupServerWorker.apply(this, arguments);
  };
}

function wrapInitialize(initialize: { apply: (arg0: any, arg1: IArguments) => any }) {
...
function wrapRequestHandler(requestHandler: { apply: (arg0: any, arg1: IArguments) => any }) {

  return function (req: string | { apply: (arg0: any, arg1: any) => any } | { originalRequest: any }, res) {
...
function wrapGetResolveRoutes(getResolveRoutes: { apply: (arg0: any, arg1: IArguments) => any }) {
  return function () {
...
function wrapResolveRoutes(resolveRoutes: { apply: (arg0: any, arg1: IArguments) => any }) {
...
function finish(
  ctx: { req?: any; res?: any; error?: any } | { metadata: any; path: any; type: any },
  result,
  err: undefined,
) {
  if (err) {
...
addHook({ name: 'next', versions: ['>=13.2'], file: 'dist/server/next-server.js' }, (nextServer: { default: any }) => {
...
addHook(
  { name: 'next', versions: ['>=11.1 <13.2'], file: 'dist/server/next-server.js' },
  (nextServer: { default: any }) => {
    const Server = nextServer.default;
