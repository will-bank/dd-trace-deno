...
function wrapFn (original: { apply: (arg0: any,arg1: IArguments) => any }, delegate: { apply: (arg0: any,arg1: IArguments) => any }) {
...
function assertFunction (target: { (arg0: any): any; apply?: (arg0: any,arg1: IArguments) => any } | ({ apply: (arg0: any, arg1: IArguments) => any; })) {
  if (!target) {
