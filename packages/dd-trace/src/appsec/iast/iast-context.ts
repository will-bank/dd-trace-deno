...
function getIastContext(store: { [x: string]: any }, topContext: { [x: string]: any }) {
 ...
 */
function saveIastContext(store: { [x: string]: any }, topContext: { [x: string]: any }, context) {
  if (store && topContext) {
...
*/
function cleanIastContext(store: { [x: string]: any }, context: { [x: string]: any }, iastContext: object) {
  if (store) {
    if (!iastContext) {
...
export { cleanIastContext, getIastContext, IAST_CONTEXT_KEY, IAST_TRANSACTION_ID, saveIastContext };
