...
import { trackEvent } from './sdk/track_event.ts';
import { setUserTags } from './sdk/set_user.ts';
...
function getLogin(credentials: { type: any; username: any }) {
...
function parseUser(login, passportUser: { id: any; _id: any; email: any; username: any; name: any }, mode: string) {
  const user = {
    'usr.id': login,
  };
...
function passportTrackEvent(
  credentials: { type: any; username: any },
  passportUser: { id: any; _id: any; email: any; username: any; name: any },
  rootSpan: { context: () => { (): any; new (): any; _tags: any } },
  mode: string,
) {
