...
function truncateSpan(
  span: { resource: string | any[]; meta: { [x: string]: string }; metrics: { [x: string]: any } },
  shouldTruncateResourceName = true,
) {
...
function normalizeSpan(span: { service: string | any[]; name: string | any[]; resource: any; type: string | any[] }) {
