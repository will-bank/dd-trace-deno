...
function fromString(str: string | any[], raddix: number | RegExp) {
...
function toHexString(buffer: any[] | Uint8Array) {
...
function readInt32(buffer: { [x: string]: number }, offset: number) {
...
function writeUInt32BE(buffer: any[], value: number, offset: number) {
...
export default (value?: string | any[], radix?: number) => new Identifier(value, radix);
