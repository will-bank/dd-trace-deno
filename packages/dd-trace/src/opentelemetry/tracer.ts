import api from 'npm:@opentelemetry/api';
import { sanitizeAttributes } from 'npm:@opentelemetry/core';
...
class Tracer {
  ...
  startSpan(name, options = {}, context = api.context.active()) {
    ...
    const links = (options.links || []).map((link: { context: any; attributes: any }) => {
      return {
