import BlockList from './ip_blocklist.ts';
...
function extractIp(config: { clientIpHeader: string | number }, req: { headers: any; socket: { remoteAddress: any } }) {
...
function findFirstIp(str: string) {
  const result = {};
